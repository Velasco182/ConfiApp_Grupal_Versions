        ...
        case "2556678":
            if(pass == 'adso2023'){
                ...
                //window.onload = function() {
                    ...
                    document.querySelector('.navbar #inicio').textContent   =    "Inicio";
                    document.querySelector('.navbar #tutores').textContent =    "Tutores";
                    document.querySelector('.navbar #rutasGuardadas').textContent  =    "Rutas guardadas";
                    document.querySelector('.navbar #miMenor').textContent    =    "Menor a cargo";
                
                    document.querySelector('.navbar #registrate').remove("registrate");
